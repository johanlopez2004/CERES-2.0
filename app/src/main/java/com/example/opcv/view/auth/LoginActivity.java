    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButtom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(usuario.isEmpty()){
                    emailLogin.setError("Ingresa correo o número");
                    return;
                }

                String loginCredential;

// Si son solo números, lo tratamos como teléfono
                if(usuario.matches("[0-9]+")){

                    if(usuario.length() != 10){
                        emailLogin.setError("Número inválido");
                        return;
                    }

                    loginCredential = usuario + "@ceres.com";
                }else{
                    // si escribió correo entra normal
                    loginCredential = usuario;
                }
